...
mixin _$DownloadsState {
  ...
  Option<Either<MainFailure, List<Downloads>>> get downloadsSorFoption =>
      throw _privateConstructorUsedError;
...
abstract class $DownloadsStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      Option<Either<MainFailure, List<Downloads>>> downloadsSorFoption});
}
...
class _$DownloadsStateCopyWithImpl<$Res, $Val extends DownloadsState>
  ...
  $Res call({
    ...
    Object? downloadsSorFoption = null,
  }) {
    return _then(_value.copyWith(
      ...
      downloads: null == downloads
          ...
          : downloads // ignore: cast_nullable_to_non_nullable
              as List<Downloads>,
      downloadsSorFoption: null == downloadsSorFoption
          ? _value.downloadsSorFoption
          : downloadsSorFoption // ignore: cast_nullable_to_non_nullable
...
class _$_DownloadsState implements _DownloadsState {
  const _$_DownloadsState(
      ...
      required this.downloadsSorFoption})
  ...
  @override
  final Option<Either<MainFailure, List<Downloads>>> downloadsSorFoption;

  @override
  String toString() {
    return 'DownloadsState(isloading: $isloading, downloads: $downloads, downloadsSorFoption: $downloadsSorFoption)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.downloadsSorFoption, downloadsSorFoption) ||
                other.downloadsSorFoption == downloadsSorFoption));
  }

  @override
  int get hashCode => Object.hash(runtimeType, isloading,
      const DeepCollectionEquality().hash(_downloads), downloadsSorFoption);
...
abstract class _DownloadsState implements DownloadsState {
  const factory _DownloadsState(
      ...
      required final Option<Either<MainFailure, List<Downloads>>>
          downloadsSorFoption}) = _$_DownloadsState;
